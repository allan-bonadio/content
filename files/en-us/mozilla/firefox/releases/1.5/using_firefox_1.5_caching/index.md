...
<html>
  ...
  <body onload="onLoad();" onpageshow="if (event.persisted) onPageShow();">
    ...
    <form
      ...
      method="get">
      <label>Date and time: <input type="text" id="timefield" /> </label><br />
      <label>Name: <input type="text" id="name" /> </label><br />
      <label>Email address: <input type="text" id="address" /> </label><br />
      <label>Order number: <input type="text" id="order" /> </label><br />
